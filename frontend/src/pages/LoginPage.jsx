...
import {MessageSquare,Loader2,Mail,Eye,Lock,EyeOff} from "lucide-react";
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="form-control">
                        ...
                        <div className="relative">
                            ...
                            <input type={showPassword ? "text" : "password"} className={`input input-bordered w-full pl-10`} placeholder="••••••••" value={formData.password}
                    ...
                    <button type="submit" className="btn btn-primary w-full font-semibold " disabled={isLoggingIn}>
                        {isLoggingIn ? (
                            <>
