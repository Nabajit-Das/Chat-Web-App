...
import { MessageSquare,User,Loader2,Mail,Eye,Lock, EyeOff } from "lucide-react";
...
const SignUpPage = () => {
  ...
  return (
    <div className="w-screen h-screen grid lg:grid-cols-2 justify-center">
      {/* Left */}
        <div className="flex flex-col  items-center justify-center p-6 sm:p-12 max-w-lg mx-auto">
